...
namespace {
struct qt_meta_tag_ZN14PeerListWidgetE_t {};
} // unnamed namespace

template <> constexpr inline auto PeerListWidget::qt_create_metaobjectdata<qt_meta_tag_ZN14PeerListWidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'onPeerListReceived'
        QtMocHelpers::SlotData<void(QByteArray)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::QByteArray, 3 },
        }}),
        // Slot 'onDhtStatusUpdated'
        QtMocHelpers::SlotData<void(uint32_t, uint32_t, uint64_t, uint64_t)>(4, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 5, 6 }, { 0x80000000 | 5, 7 }, { 0x80000000 | 8, 9 }, { 0x80000000 | 8, 10 },
        }}),
        // Slot 'onEventReceived'
        QtMocHelpers::SlotData<void(uint8_t, uint32_t, QByteArray)>(11, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 12, 13 }, { 0x80000000 | 5, 14 }, { QMetaType::QByteArray, 15 },
        }}),
        // Slot 'onConnected'
    ...
    return QtMocHelpers::metaObjectData<PeerListWidget, qt_meta_tag_ZN14PeerListWidgetE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject PeerListWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14PeerListWidgetE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14PeerListWidgetE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN14PeerListWidgetE_t>.metaTypes,
    nullptr
} };
...
void *PeerListWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN14PeerListWidgetE_t>.strings))
